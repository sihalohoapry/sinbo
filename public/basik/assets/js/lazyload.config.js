...
var MODULE_CONFIG = {
    ...
    dataTable:      [
                      '../basik/libs/datatables/media/js/jquery.dataTables.min.js',
                      '../basik/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js',
                      '../basik/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css',
                      '../basik/assets/js/plugins/datatable.js'
                    ],
    bootstrapTable: [
