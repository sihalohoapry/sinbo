                            ...
                            <div class="card-body">
                                    <div class="form-row mr-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text"  disabled value="{{ $booking->User->name }}"  class="form-control">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="text-muted">Service Selesai</label>
                                            <input type="text"  disabled value="{{ $booking->updated_at}}"  class="form-control">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label  class="text-muted">Judul Booking</label>
                                            <input type="text" value="{{ $booking->title_booking }}" readonly class="form-control">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label  class="text-muted">Total Keseluruhan</label>
                                            <input type="text" value="Rp {{ $allTotal }}" readonly class="form-control">
                                        </div>
                                    </div>
